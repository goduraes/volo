    ...
    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      ...
      >
        ...
        <AnimationDiv
          duration="duration-[1.2s]"
          inView={inView}
          className="flex flex-col justify-center items-center md:items-end relative col-span-1"
        >
          <Image
            priority
            src={HomeBanner}
          ...
          <AnimationDiv
            ...
            inView={inView}
            className="avatar-container hidden lg:flex items-center h-14 absolute top-[150px] left-10 bg-white shadow-2xl p-1 rounded-[36px]"
          >
            <Image
          ...
          <AnimationDiv
            duration="duration-[1.8s]"
            inView={inView}
            className="avatar-container hidden lg:flex items-center h-14 absolute bottom-[150px] left-0 bg-[#F39568] shadow-2xl p-1 rounded-[36px]"
          >
            <Image
              className="h-12 w-auto rounded-full"
              priority
